...
#include "ros_code/ros_actionAction.h"
#include <iostream>
#include <sstream>
...
protected:
  ...
  ros_code::ros_actionFeedback feedback;
  ros_code::ros_actionResult result;
...
public:
  ...
  void executeCB(const ros_code::ros_actionGoalConstPtr &goal)
  {
